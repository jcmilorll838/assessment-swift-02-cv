...
class Challenge3Tests: XCTestCase {
    func testCase1() {
        let value = findLessCostPath(board: [
            [42, 51, 22, 10, 0],
            [2, 50, 7, 6, 15],
            [4, 36, 8, 30, 20],
            [0, 40, 10, 100, 1],
    ...
    func testCase4() {
        let value = findLessCostPath(board: [[42]])
